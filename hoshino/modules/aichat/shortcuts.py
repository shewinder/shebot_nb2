...
BUILT_IN_SHORTCUTS: Dict[str, dict] = {
    "角色扮演": {
        "prompt": (
            ...
            "【配图生成】\n"
            "- 每次回复后，请使用 image_generation skill 生成当前场景的配图\n"
            "- 生图 prompt 使用【场景画面】中的完整描述，模型优先使用 novaAnimeXL_ilV180 或 WAI-illustrious\n"
            "- 让画面与剧情文字保持一致\n\n"
            "【其他要求】\n"
            "- 保持角色一致性，剧情连贯\n"
            "- 开场白同样需要包含【剧情】【选项】【场景画面】三个部分\n\n"
