...
强匹配、降权/回避、边界条件。重要结论放在第一段，不要写历史流水账。）

示例:
> 强匹配：日系高完成度赛璐璐/精致平涂，浅色发（蓝/银白/金）+ 紫/蓝眸少女，
> 通过服饰和构图展现身体线条，偏好俯视、背影/臀部视角、女仆/泳装/贴身服饰、
> 美学化百合或轻度 NSFW。降权：欧美粗线条、福瑞/兽人、夸张肉体、含男性的
> 粗暴重度 R-18、偷拍/羞耻/侵犯设定。边界：成女可接受但必须保持日系协调比例；
> 百合 R-18 可接受，但全裸直白体液表达需要谨慎降权。
...
（有明确负反馈、显式声明，或与核心审美持续冲突的内容，区分程度。）
...
- 浅色发 + 紫/蓝眸：由多次显式正反馈和持续浏览共同支持，是核心锚点。
- 百合 R-18：正向信号明确，但直白全裸/体液表达处在边界。
- 含男性重度 R-18：多次中性浏览但与核心偏好冲突，筛选时倾向降权。
- ...
...
- `核心审美画像` 必须解释审美内核，不要退化成标签计数。
- `强匹配特征` 只放稳定、高置信度、可用于推荐筛选的特征。
