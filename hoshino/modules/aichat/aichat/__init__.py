...
# MCP 导入
from .mcp import mcp_server_manager, mcp_tool_bridge, init_mcp_session_manager
...
# ── 搜索 Provider 切换 ──
from .tools.builtin.search_providers import switch_provider, list_providers, get_provider
